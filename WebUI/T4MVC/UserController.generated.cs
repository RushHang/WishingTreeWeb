...
namespace WishingTree.WebUI.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_UserController: WishingTree.WebUI.Controllers.UserController {
        ...
        public override System.Web.Mvc.ActionResult Login(WishingTree.WebUI.Models.UserModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Login);
        ...
        public override System.Web.Mvc.ActionResult Register(WishingTree.WebUI.Models.UserModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
